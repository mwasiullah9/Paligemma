...
class SiglipVisionConfig:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.num_attnetion_layer = num_attnetion_layer
...
class SiglipVisionEmbeddings(nn.Module):
    def __init__(self, config: SiglipVisionConfig):
        ...
        def forward(self, pixel_values: torch.FloatTensor) -> torch.Tensor:
            ...
            _, _, height, width = self.pixel_values.shape
...
class SiglipMLP(nn.Module):
    ...
    def forward(self, hidden_size: torch.Tensor) -> torch.Tensor:
        ...
        hidden_states = nn.funtional.gelu(hidden_states, approximate="tanh")
